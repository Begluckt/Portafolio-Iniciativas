    ...
    try {
      ...
      if (res.ok) {
        setFormData(prev => ({
          ...
          ini_owner: data.ini_owner || prev.ini_owner,
          ini_sponsor: data.ini_sponsor || prev.ini_sponsor,
          ini_priority: data.ini_priority || prev.ini_priority,
          ...
          val_revenue: data.val_revenue || prev.val_revenue,
          val_efficiency: data.val_efficiency || prev.val_efficiency,
          ...
          dur_capacity: data.dur_capacity || prev.dur_capacity,
